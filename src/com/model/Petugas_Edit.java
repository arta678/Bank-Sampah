 ...
 * @author artawgn
 */
public class Petugas_Edit extends javax.swing.JDialog {

    /**
     * Creates new form Nas_tambah
     */
    public Petugas_Edit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            s.setSaldo_nas("0");
            ...
            if (Fungsi.updatePetugas(s)) {

//                setClean();
                Fungsi.Tabel_petugas("");
//                ts.clickGo();
                JOptionPane.showMessageDialog(this,
                        "Updata Data Sukses !", "INFORMASI", JOptionPane.INFORMATION_MESSAGE);

            } else {
                JOptionPane.showMessageDialog(this,
                        "Update Data Gagal !", "ERROR", JOptionPane.ERROR_MESSAGE);
            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Petugas_Edit dialog = new Petugas_Edit(new javax.swing.JFrame(), true);
